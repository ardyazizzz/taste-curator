  ...
  return (
    <main className="app-shell">
      ...
      <header className="topbar">
        <div className="brand-lockup" aria-label="Taste Tile">
          <div className="brand-mark"><span /><span /><span /></div>
          <span>TASTE TILE</span>
        </div>
